...
function TestManagementPage() {
  ...
  //测试数据 Test Data
  const items = [
    { id: 1, name: "Do you feel energetic?", description: "平和质" },
    { id: 2, name: "Do you feel tired easily?", description: "平和质" },
    {
      id: 3,
    ...
    { id: 9, name: "Do you feel tired easily?", description: "气虚质" },
    {
      id: 10,
      name: "Do you feel shortness of breath easily?",
      description: "气虚质",
    },
    { id: 11, name: "Does your voice sound too soft? ", description: "气虚质" },
    {
      id: 12,
